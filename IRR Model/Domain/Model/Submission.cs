...
public partial class Submission
{
    ...
    public virtual User? Actuary { get; set; }

    public virtual User? ActuaryPeerReviewer { get; set; }
    ...
    public virtual Submission? ExpiringSubmission { get; set; }

    public virtual CedentContact? GroupBuyer { get; set; }

    public virtual ICollection<GuAnalysis> GuAnalyses { get; set; } = new List<GuAnalysis>();

    public virtual ICollection<Submission> InverseExpiringSubmission { get; set; } = new List<Submission>();

    public virtual User? LastRegisSyncByUser { get; set; }

    public virtual ICollection<Layer> Layers { get; set; } = new List<Layer>();

    public virtual LegalTerm? LegalTerms { get; set; }

    public virtual CedentContact? LocalBuyer { get; set; }
    ...
    public virtual User? Modeler { get; set; }

    public virtual ICollection<PolicyUpdate> PolicyUpdates { get; set; } = new List<PolicyUpdate>();

    public virtual Programme Program { get; set; } = null!;

    public virtual ICollection<ProgramRoeResult> ProgramRoeResults { get; set; } = new List<ProgramRoeResult>();

    public virtual User? RelshipUnderwriter { get; set; }

    public virtual ICollection<RiskTransferAnalysis> RiskTransferAnalyses { get; set; } = new List<RiskTransferAnalysis>();
    ...
    public virtual SubmissionWriteup SubmissionWriteup { get; set; } = null!;

    public virtual User Underwriter { get; set; } = null!;
}
